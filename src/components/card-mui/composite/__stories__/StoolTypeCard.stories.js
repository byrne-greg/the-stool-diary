...
export const Provided_Select_Button = () => {
  ...
  return (
      <StoolTypeCard 
        ...
        isSelected={false}
        handleClick={action("clicked")}
        selectButton={<OutlineButton color={theme.palette.info} onClick={action("clicked")}>Select</OutlineButton>}
      />
  )
}
...
export const Provided_Deselect_Button = () => {
  ...
  return (
      <StoolTypeCard 
        ...
        isSelected={true}
        handleClick={action("clicked")}
        deselectButton={<FilledButton color={theme.palette.info} onClick={action("clicked")}>Deselect</FilledButton>}
      />
  )
}