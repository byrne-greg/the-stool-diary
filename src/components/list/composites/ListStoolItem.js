...
const ListStoolItem = ({
  ...
  const stoolClass = stoolClassifications.find(
    stoolClass => stoolClass.type === stoolType
  )
    ...
    <li className={classes.listItem} data-testid="list-stool-item">
      {stoolClass && (
        <div
          ...
          data-testid="list-stool-item-type-image"
        >
          {stoolClass.image}
        </div>
      )}
      <div className={classes.listItemTextContainer}>
        <div data-testid="list-stool-item-type">
          <Typography variant="h4" className={classes.listItemTitle}>
            {t("Type")} {stoolType ? stoolType : t("Invalid")}
          </Typography>
        </div>
        {stoolDateTime ? (
        ...
        {stoolSize ? (
          <div
            ...
            data-testid="list-stool-item-size"
          >
            <Chip
              className={classes.chip}
              label={
                <Typography variant="h6" component="p">
                  {t(convertToProperCase(stoolSize))}
                </Typography>
              }
            />
          </div>
