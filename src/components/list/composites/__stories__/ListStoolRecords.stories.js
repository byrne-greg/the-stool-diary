...
export const EmptyStoolRecordsWithTitle = () => {
  return (
    <ListStoolRecords recordedStools={[]} titleComponent={<Typography variant="h4">A Title</Typography>}/>
  )
}
...
export const ListWithTitle = () => {
  ...
  return (
  <ListStoolRecords recordedStools={allRecordedStoolData} titleComponent={<Typography variant="h4">A Title</Typography>}/>
  )
}
...
export const MultipleStoolRecordsWithoutDaySeparators = () => {
  ...
  return (
    <ListStoolRecords recordedStools={allRecordedStoolData} displayDaySeparators={false} />
  )
}
