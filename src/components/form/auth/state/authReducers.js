...
export const authReducer = (state, action) => {
  ...
  switch (type) {
    ...
    case UPDATE_FIRSTNAME:
      newState = {
        ...state,
        firstName: { ...state.firstName, value: newValue },
      }
      break
    case UPDATE_FIRSTNAME_ERROR:
      newState = {
        ...state,
        firstName: { ...state.firstName, error: newValue },
      }
      break
    case UPDATE_LASTNAME:
      newState = { ...state, lastName: { ...state.lastName, value: newValue } }
      break
    case UPDATE_LASTNAME_ERROR:
      newState = { ...state, lastName: { ...state.lastName, error: newValue } }
      break
