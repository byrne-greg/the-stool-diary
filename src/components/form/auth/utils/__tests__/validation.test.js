...
describe("Auth Text Field Validation Rules", () => {
  describe("validateFormTextField", () => {
    describe("All", () => {
      test("validation fails when text field value is not specified", () => {
        // GIVEN
      ...
      test("validation fails when text field value is null", () => {
        // GIVEN
      ...
      test("validation fails when text field value is undefined", () => {
        // GIVEN
      ...
      genericCharLengths.forEach(fieldChars => {
        test(`validation fails when text field value contains ${fieldChars} character`, () => {
          // GIVEN
    ...
    describe("Email", () => {
      ...
      test("validation fails when email text field input contains spaces", () => {
        // GIVEN
      ...
      sampleIncorrectEmails.forEach(incorrectEmailFormat => {
        test(`validation fails when email text field input contains incorrect email format - ${incorrectEmailFormat}`, () => {
          // GIVEN
      ...
      sampleAllowedEmails.forEach(allowedEmailFormat => {
        test(`validation passes when email text field input contains allowed email format - ${allowedEmailFormat}`, () => {
          // GIVEN
    ...
    describe("Password", () => {
      ...
      passwordCharLengths.forEach(passwordChars => {
        test(`validation fails when password text field input contains than ${passwordChars} characters`, () => {
          // GIVEN
          // replace any , in test value
      ...
      test("validation fails when password text field input does not contain a special character", () => {
        // GIVEN
      ...
      test("validation fails when password text field input does not contain any uppercase characters", () => {
        // GIVEN
      ...
      test("validation fails when password text field input does not contain any lowercase characters", () => {
        // GIVEN
      ...
      test("validation fails when password text field input does not contain any numbers", () => {
        // GIVEN
        const testValue = "ABCdefgh!"
      ...
      test("validation passes when password text field contains special characters, numbers, and upper and lowercase chars", () => {
        // GIVEN
        const testValue = "Super_Secret_Password1"
