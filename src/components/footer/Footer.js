...
const StoolImagesAttribution = () => {
  const classes = useStyles();
  return(
    <div>Stool images sourced from freely licensed media file created by <a href="https://web.archive.org/web/20110205170819/http://en.wikipedia.org/wiki/File:Bristol_Stool_Chart.png" title="Stool Images from Wikimedia Commons" className={classes.linkDecoration}>Kyle Thompson from Wikimedia Commons</a></div>
  )
}
