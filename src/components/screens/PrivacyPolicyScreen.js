      ...
      <div id="md_en" data-target="out_en" className="agreement_md">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to the Stool Diary.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to the Stool Diary, accessible
              from{" "}
              <a
                href="https://stooldiary.netlify.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://stooldiary.netlify.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://stooldiary.netlify.app/contact/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://stooldiary.netlify.app/contact/
            </a>
          </li>
        </ul>
      </div>
